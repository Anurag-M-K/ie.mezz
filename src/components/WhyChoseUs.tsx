  ...
  return (
    <div className='text-center bg-yellow-100 p-3 sm:p-8'>
      ...
      <FaPersonCircleCheck className="text-red-500  w-[100px] h-[100px]" />
        ...
        <p className='text-gray-800 text-md'>With our wide Menu and Affordable prices, you can personalize your order.</p>
      </div>
      <div className='flex m-14 sm:m-28 justify-center items-center flex-col'>
      <RiEBike2Fill  className="text-red-500  w-[100px] h-[100px]" />
        ...
        <p className='text-gray-800  text-md'>Delivery services right to your door, free of charge. Pick the time and location for your food delivery.</p>
